...
import { Protocol, MetadataField, ControlDefinition, ParseFormat, NormalizationType, ControlType, FieldType } from '../../../types/mapperTypes';
            ...
            <div className="d-flex justify-content-between align-items-center">
              ...
              <div>
                {isEditing ? (
                  ...
                  <>
                    <Button size="sm" variant="success" onClick={handleAddProtocol} className="me-2">
                      <Plus size={16} /> New
                    </Button>
                      ...
                      <Form.Group className="mb-3">
                        ...
                        <Form.Select
                          ...
                          onChange={(e) => setEditingProtocol({
                            ...
                            parseStrategy: {
                              ...editingProtocol.parseStrategy,
                              plateSize: parseInt(e.target.value)
                            }
                          })}
                          disabled={!isEditing}
                        >
                    ...
                    <Col md={6}>
                      <Form.Group className="mb-3">
                        ...
                        >
                          ...
                          <option value="cell">Cell in file</option>
                        </Form.Select>
                      </Form.Group>
                    </Col>
                ...
                <Accordion.Body>
                  <Form.Group className="mb-3">
                    ...
                    <Form.Select
                      ...
                      disabled={!isEditing}
                    >
                      <option value="PctOfCtrl">Percent of Control</option>
                          ...
                          <Col md={4}>
                            <Form.Group>
                              ...
                              <Form.Select
                                ...
                                disabled={!isEditing}
                              >
                                <option value="MaxCtrl">Max Control</option>
                                <option value="MinCtrl">Min Control</option>
                                <option value="PosCtrl">Positive Control</option>
                                <option value="NegCtrl">Negative Control</option>
