            ...
            <Card className="shadow-sm flex-fill">
              <Card.Body>
                ...
                <ul className="template-card">
                  ...
                  <li><strong>Combination-N:</strong> Combines member compounds N at a time (N is the fold), covering every N-way combination of compounds sharing the pattern. For Combination-2 only, giving Direction as two perpendicular directions (<i>e.g.,</i> "LR-TB") lays the pair out as a perpendicular matrix, with each compound walking its own axis. Any other case (Combination-2 with a single direction, or Combination-3 and higher) is collinear, with every member compound sharing one dilution direction. Note this is concentration-driven and enumerated for you; to dispense a hand-written list of mixtures at fixed volumes instead, use the <Link to="/cocktailbuilder">Cocktail Builder</Link>.</li>
                </ul>
              </Card.Body>
            </Card>
          </Col>
